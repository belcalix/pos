...
<!-- end loader -->
  ...
  <a href="orders.php" class="bg-dark text-white"><i class="fa fa-shopping-cart"></i></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title font-weight-bold">Pending Orders</h2>
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title font-weight-bold">Completed Orders</h2>
                            <p class="card-text text-center" style="font-size: 30px;">
                                <?php
                                $done = mysqli_query($con,"SELECT * FROM orders WHERE order_status = 'Done'");
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title font-weight-bold">Total Profits</h2>
                            <p class="card-text text-center" style="font-size: 30px;">Php 
                                <?php
                                $profit = mysqli_query($con,"SELECT SUM(order_total) as total FROM orders WHERE order_status = 'Done'");
                                $count = mysqli_fetch_array($profit);
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="table1">
                                        ...
                                        <tbody>
                                            <?php
                                            $pending = mysqli_query($con,"SELECT * FROM orders ORDER BY order_id DESC");
